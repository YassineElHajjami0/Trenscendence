...
const UpperNav = () => {
  ...
  //     const response = await fetch(`http://10.13.4.4:3000/users/${loggedU}`, {
  //       headers: {
  ...
  const getNotifications = async () => {
    ...
    try {
      const res = await fetch(
        `http://10.13.4.4:3000/notifications/${loggedU}`,
        {
          headers: {
            Authorization: `Bearer ${userTok}`,
            "Content-Type": "application/json",
  ...
  const getAllUsers = async () => {
    ...
    try {
      const res = await fetch(
        `http://10.13.4.4:3000/users/allusers/${loggedU}`,
        {
          headers: {
            Authorization: `Bearer ${userTok}`,
            "Content-Type": "application/json",
    ...
    <div className="upperNav">
      ...
      <div ref={notificationRef} className="notif-and-profilePic">
        ...
        <div className="profile-picture">
          <div>
            <Image
              src={userAV || `http://10.13.4.4:3000/default.png`}
              alt="P"
              width={45}
              height={45}
              loading="lazy"
