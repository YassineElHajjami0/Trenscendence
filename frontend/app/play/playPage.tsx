...
const images = [table6, table4, table5, table3, table7, table8, table9, table1, table2];
...
function BoardTheme() {
	...
	return (
		<div>
			<div className="upperTitle"> <h2>Choose a table</h2> </div>
...
function GameMode() {
	...
	return (
		<div>
			...
			<div className="upperTitle"> <h2>Choose the enemy</h2> </div>
			<div className='game-mode-container'>
				<div className='game-mode-card'>
					<span className='mode-game-button' onClick={handleGotoBotGame}>
						Against Robot
					</span>
					<img src={robotMode.src} alt="Game Mode" onClick={() => {setGameMode('robot')}}/>
				</div>
				<div className='game-mode-card'>
